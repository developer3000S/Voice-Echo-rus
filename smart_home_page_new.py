...
class VoiceHomePage(QWidget):
    def __init__(self, parent=None):
        ...
        self.setObjectName("VoiceHomePageModern")
        self.setStyleSheet(f"QWidget#VoiceHomePageModern {{ background: transparent; }} QScrollArea {{ background: transparent; border: none; }}")
