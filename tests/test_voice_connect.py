...
from voice_connect.gateway.command_router import CommandRouter
from voice_connect.gateway.device_manager import DeviceManager
from voice_connect.gateway.capability_manager import CapabilityManager
from voice_connect.gateway.models import DeviceRecord
from voice_connect.gateway.pairing import PairingManager
from voice_connect.gateway.protocol import ProtocolTypes, build_message, validate_message
from voice_connect.gateway.websocket import ConnectionHub
...
def test_pairing_manager_returns_expiring_offer():
    ...
    assert offer.service == "_VOICE._tcp.local."
