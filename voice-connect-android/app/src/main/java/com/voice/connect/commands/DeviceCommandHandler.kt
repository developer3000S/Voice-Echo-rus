package com.voice.connect.commands
...
import com.voice.connect.core.VoiceConnectCapabilities
import com.voice.connect.core.CommandResult
import com.voice.connect.device.AndroidDeviceInfoProvider
...
class DeviceCommandHandler(private val context: Context) {
    ...
    private fun getDeviceInfo(): CommandResult {
        ...
        return CommandResult(
            ...
            data = mapOf(
                ...
                "capabilities" to VoiceConnectCapabilities.INITIAL,
            ),
        )
    }
    ...
    private fun unlockPhone(parameters: Map<String, Any?>): CommandResult {
        ...
        val service = com.voice.connect.accessibility.VoiceAccessibilityService.instance
        if (service == null) {
            return CommandResult(false, errorCode = "ACCESSIBILITY_DISABLED", error = "Voice Accessibility Service is not enabled.")
        }
