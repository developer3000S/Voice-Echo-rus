...
class VoiceGatewayDiscovery(private val context: Context) {
    ...
    fun start(onFound: (GatewayEndpoint) -> Unit, onError: (String) -> Unit = {}) {
            ...
            override fun onServiceResolved(serviceInfo: NsdServiceInfo) {
                ...
                if (host.isNotBlank() && port > 0) {
                    val endpoint = GatewayEndpoint(
                        name = serviceInfo.serviceName ?: "Voice PC",
                        host = host,
                        port = port,
                    )
        ...
        discoveryListener = object : NsdManager.DiscoveryListener {
            ...
            override fun onServiceFound(serviceInfo: NsdServiceInfo) {
                ...
                if (!serviceType.contains("_VOICE._tcp", ignoreCase = true)) return
        ...
        runCatching {
            nsdManager.discoverServices("_VOICE._tcp.", NsdManager.PROTOCOL_DNS_SD, discoveryListener)
        }.onFailure {
